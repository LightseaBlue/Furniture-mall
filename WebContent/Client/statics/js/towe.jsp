...
#top div {
	...
	<div id="top">
		<div style="">
			<p class="l">Wellcome to genova office!</p>
			<p class="r">
		...
		<div class="wp pr">
			...
			<div class="nav">
				<ul class="ul-nav">
					...
					<li class=""><a href="about.jsp">关于某某</a></li>
					...
					<li class=""><a href="contact.jsp">联系我们</a></li>
				</ul>
	...
	<div class="wp">
		<div class="jz-cont" style="position: relative;">
			...
			<span class="wow fadeInUp" data-wow-delay="0.2s">追求新颖时尚办公环境是某某十余年发展历程中沉淀和积累的文化价值</span>
			<p class="wow fadeInUp" data-wow-delay="0.4s">国际贸易部：0571-88929396
				maya@genzo-china.com</p>
			<p class="wow fadeInUp" data-wow-delay="0.6s">国内销售部：0500-86666666
				455106910@qq.com</p>
			<div class="col-l wow fadeInLeft">
				<h4>
					<font color="#666">联系方式</font>
				</h4>
				<p>电话：400-000-0000/0500-86666666</p>
				<p>邮箱：maya@genzo-china.com</p>
			</div>
			<div class="col-r wow fadeInRight">
				<h4>
					<font color="#666">浙江某某家具制造有限公司</font>
				</h4>
				<p>厂部地址：浙江省杭州市余杭区崇贤街道北庄工业园</p>
				<p>厂部地址：浙江省湖州市德清县乾元镇威明街1号</p>
				<p>展厅地址：浙江省杭州市余杭区崇贤街道运河路188号</p>
			</div>
		</div>
	</div>
	<div class="h20"></div>
